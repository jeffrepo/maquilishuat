    ...
    def _get_kardex(self,fecha_inicio,fecha_fin,productos_ids):
        ...
        if movimientos:
            for m in movimientos:
                ...
                costo_final = round(movimientos_productos[m.product_id.id]['existencia_final'] *  m.product_id.standard_price, 2)
                ...
                movimientos_productos[m.product_id.id]['stock_move_line'].append({
                    ...
                    'costo_actual':  round(movimientos_productos[m.product_id.id]['existencia_final'] *  m.product_id.standard_price,2)
                })
                # movimientos_productos[m.product_id.id]['existencia_final'] -= cantidad_salidas
