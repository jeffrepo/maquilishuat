...
class ReportEntradaSalidaProducto(models.AbstractModel):
    _name = 'report.maquilishuat.entrada_salida_producto'
    ...
    def _get_entrada_salida(self,fecha_inicio,fecha_fin,productos_ids):
    ...
    def get_report_values(self, docids, data=None):
        ...
        return {
            ...
            '_get_entrada_salida': self._get_entrada_salida,
