    ...
    def _get_kardex(self,fecha_inicio,fecha_fin,productos_ids):
        ...
        if movimientos:
            for m in movimientos:
                ...
                costo_final = (m.currency_id.round(movimientos_productos[m.product_id.id]['existencia_final'] *  m.product_id.standard_price) if m.currency_id else round(movimientos_productos[m.product_id.id]['existencia_final'] *  m.product_id.standard_price, 2))
